package com.dhruv194.firebasewebrtc.webrtc
...
class WebRTCClient @Inject constructor(
    ...
    fun initializeWebRTCClient(
        ...
        peerConnection = createPeerConnectionObserver(observer)
    }

    private fun createPeerConnectionObserver(observer: PeerConnection.Observer): PeerConnection? {
    ...
    fun initLocalSurfaceView(localSurfaceView : SurfaceViewRenderer, isVideoCall:Boolean){
            this.localSurfaceView =localSurfaceView
            initSurfaceView(localSurfaceView)
        startLocalStreaming(localSurfaceView, isVideoCall)
    }

    private fun startLocalStreaming(localSurfaceView: SurfaceViewRenderer, isVideoCall: Boolean){
    ...
    interface Listener{
        fun onTransferEventToSocket(dataModel: DataModel)
    }
}